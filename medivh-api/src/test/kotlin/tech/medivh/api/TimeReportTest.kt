...
class TimeReportTest {
    ...
    fun testHoursMinutesSeconds() {
        ...
        val result = TimeReport.formatTime(duration.toNanos(), TimeUnit.SECONDS)
    ...
    fun testSecondsMillisecondsMicrosecondsNanoseconds() {
        ...
        val result = TimeReport.formatTime(duration.toNanos(), TimeUnit.MICROSECONDS)
    ...
    fun testNanoseconds() {
        ...
        val result = TimeReport.formatTime(duration.toNanos(), TimeUnit.NANOSECONDS)
    ...
    fun testOnlySeconds() {
        ...
        val result = TimeReport.formatTime(duration.toNanos(), TimeUnit.MILLISECONDS)
